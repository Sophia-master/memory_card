...
question_list = []
question_list.append(Question('Ты умный', 'нет', 'да', 'не знаю', 'почему?'))
question_list.append(Question('Столица Парижа', 'В смысле?', 'Амстердам', 'Франция', 'Китай'))
question_list.append(Question('Какого цвета снег?', 'белого', 'прозрачного', 'желтого', 'я дальтоник'))
question_list.append(Question('Что такое school', 'школа', 'интернат', 'пристанище дьявола', 'институт'))
